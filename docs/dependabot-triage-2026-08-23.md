...
- `gh pr list --state all --author app/dependabot` → 6 PRs, all closed or merged
...
|---|---|---|---|
| `dependabot/npm_and_yarn/multi-3914ecf801` | #43 | Bump vite 5.4.21→8.1.5 and vitest 2.1.9→4.1.10 (grouped) | **Merged** (by kyle886, 2026-08-23) — commit `3be4311` in `main` |
